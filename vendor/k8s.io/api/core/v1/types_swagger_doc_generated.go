...
var map_ContainerImage = map[string]string{
	...
	"names":     "Names by which this image is known. e.g. [\"registry.cn-hangzhou.aliyuncs.com/google_containers/hyperkube:v1.0.7\", \"dockerhub.io/google_containers/hyperkube:v1.0.7\"]",
